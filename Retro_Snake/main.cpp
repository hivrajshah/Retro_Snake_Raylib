...
using namespace std;
Color green = {3,57,108,255};

Color yellow = {179,205,224,255};
...
int main () {
    ...
    while(WindowShouldClose()==false)
    {
       ...
       if(IsKeyPressed(KEY_D) && game.snake.direction.x != -1)
       {
        ...
        DrawText(" Retro Snake by Vraj ",offset-5,20,40,green);
        DrawText(TextFormat("Score : %i ",game.score),offset-5,offset+cellSize*cellCount+10,40,green);
        DrawText(TextFormat(" Highest Score : %i ",game.highscore),(cellSize*cellCount)-(cellCount*12),offset+cellSize*cellCount+10,40,green);
        game.Draw();
